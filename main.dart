  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Container(
            padding: const هذه الإرشادات EdgeInsets.all(12),
            ...
            child: const Text(
              '💡 هذه هي الجوائز التي تظهر داخل عجلة الحظ. اضغط على ✏️ للتعديل، 🗑️ للحذف، أو ➕ في الأعلى لإضافة جائزة جديدة.',
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text('وزن ${prize.weight}  •  ${prize.points > 0 ? "${prize.points}pt" : prize.type}  •  ${prize.isActive ? "مفعل" : "معطل"}',
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      icon: const Icon(Icons.edit, color: Color(0xFFFFB300), size: 20),
                      onPressed: () {},
                    ),
                    IconButton(
